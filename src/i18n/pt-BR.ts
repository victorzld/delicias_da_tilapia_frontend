const ptBR = {
  ...
  innPage: {
    ...
    lodgingP1:
      "Nossos 15 chalés foram projetados para oferecer conforto e contato direto com a natureza. Cada unidade conta com varanda, frigobar, e uma vista deslumbrante para as montanhas de Domingos Martins.",
    lodgingP2:
    ...
    additionalPricing: [
      { label: "Criança até 4 anos", price: "Cortesia" },
      { label: "De 5 a 15 anos", price: 100 },
      { label: "Acima de 15 anos", price: 140 },
      { label: "Pet", price: 50 },
    ],
    jacuzziNote: "* Hidromassagem disponível apenas nos chalés 08 e 10",
  },
  fishingPage: {
    heroTitle: "Pesque e Pague",
    heroSubtitle: "Diversão e pescaria para toda a família",
    subtitle: "A experiência",
    title: "Pesque e Pague & Pesca Esportiva",
    description:
      "Escolha a modalidade que mais combina com você e aproveite um dia relaxante em meio à natureza exuberante das montanhas capixabas.",
    p1: "Nosso espaço oferece duas modalidades de pesca para garantir a diversão desde a família que busca lazer até os pescadores esportivos mais experientes. Aqui a emoção é garantida com peixes de 300g a 30kg!",
    p2: "Contamos com mais de 10 variedades de peixes em nossos tanques, incluindo: tambaqui, piau, catfish, matrinxã, curimatã, pirarara, traíra, tilápia, pintado, dourado, bagre e muito mais.",
    pesquePague: {
      title: "Pesque e Pague",
      rules: [
        "R$ 20,00 o kg do peixe sujo",
        "R$ 3,00 por kg para limpar",
        "Limpeza dos peixes até às 16:00H",
        "Fornecemos varinhas e massinha",
    ...
    pescaEsportiva: {
      ...
      rules: [
        "R$ 25,00 por pessoa",
        "Hóspede da pousada NÃO PAGA",
        "Precisa trazer todo o material de pesca esportiva profissional",
      ],
    },
    features: [
      { label: "Mais de 10 espécies", desc: "Tambaqui, pirarara, tilápia..." },
      { label: "Horário", desc: "08:00h às 17:00h" },
      { label: "Peixes Gigantes", desc: "De 300g a até 30kg" },
      { label: "Para todos", desc: "Iniciantes e profissionais" },
    ],
    ctaTitle: "Quer saber mais?",
    ctaDesc: "Entre em contato para tirar dúvidas e agendar sua visita.",
